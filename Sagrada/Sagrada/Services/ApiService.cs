    ...
    public class ApiService {
        public async Task<Response> CheckConnection() {
            if (!CrossConnectivity.Current.IsConnected) {
                return new Response {
                    IsSuccess = false,
                    Message = "Por favor, active los servicios de internet",
                };
            }
            ...
            if (!isReachable) {
                return new Response {
                    IsSuccess = false,
                    Message = "Por favor, Chequee su conexión a internet",
                };
            }
        ...
        public async Task<Response> GetWith2Parameters<T>(
            string urlBase,
            string servicePrefix,
            string controller,
            string tokenType,
        ...
        public async Task<Usuario> GetUserByEmail(
            string urlBase,
            string servicePrefix,
            string controller,
            string tokenType,
